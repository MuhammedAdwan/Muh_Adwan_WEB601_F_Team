...
export class ContentListComponent {
  contentArray = [
    ...
    },
    {
      ...
      creator: 'The Sun',
      imgURL: 'https://media.video-cdn.espn.com/motion/2024/0110/dm_240110_carvajal_goal/dm_240110_carvajal_goal.jpg',
      type: 'Defender',
      tags: ['Carvajal', 'Spain']
    },
    {
    ...
    },
    {
      id: 7,
      title: 'Zinedin Zidan',
      description: 'Zizou scoring the winning goal which helped Real Madrid to be the champions for the 9th time',
      creator: 'SportBible',
  ...
  filteredContentArray = this.contentArray;
  searchTitle: string = '';
